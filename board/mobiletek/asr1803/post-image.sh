...
{
    kernel-image
	cp ${BINARIES_DIR}/u-boot.bin ${BINARIES_DIR}/openwrt-mmp-asr1803-u-boot.bin
	cp ${BINARIES_DIR}/rootfs.squashfs ${BINARIES_DIR}/openwrt-mmp-asr1803-root.squashfs
	cp ${BINARIES_DIR}/rootfs.ubi ${BINARIES_DIR}/openwrt-mmp-asr1803-oem_data.ubi
